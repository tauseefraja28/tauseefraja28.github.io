jQuery(document).ready(function($) {
            ...
            success: function(msg)
            {
                ...
                if (msg == 'success') {
                    ...
                    response = '<div class="alert alert-success success-send">' +
                            ...
                            '<i class="fa fa-ok" style="margin-right: 5px;"></i> ' + $success
                            + '</div>';
                    ...
                    response = '<div class="alert alert-danger error-send">' +
                            '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' +
                            '<i class="fa fa-remove" style="margin-right: 5px;"></i> ' + output_error
                            + '</div>';
    ...
    $(".resp-tabs-container h2.resp-accordion").each(function() {
        ...
        if ($(this).hasClass('resp-tab-active')) {
            $(this).append("<i class='fa fa-chevron-up arrow-tabs'></i>");
        } else {
            $(this).append("<i class='fa fa-chevron-down arrow-tabs'></i>");
        }
    });

    $(".resp-tabs-container h2.resp-accordion").click(function() {
        if ($(this).hasClass('resp-tab-active')) {
            $(this).find("i.arrow-tabs").removeClass("fa-chevron-down").addClass("fa-chevron-up");
        }

        $(".resp-tabs-container h2.resp-accordion").each(function() {

            if (!$(this).hasClass('resp-tab-active')) {
                $(this).find("i.arrow-tabs").removeClass("fa-chevron-up").addClass("fa-chevron-down");
            }
        });
